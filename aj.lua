...
local function addLogEntry(data)
    ...
    LogItem.Size = UDim2.new(1, -10, 0, 65) -- Increased height to fit everything
    ...
    Name.Text = "🏷️ " .. (data.name or "Unknown")
    Name.TextColor3 = T.White
    Name.TextSize = 11
    Name.TextXAlignment = Enum.TextXAlignment.Left

    local Value = Instance.new("TextLabel", Left)
    Value.Size = UDim2.new(1, 0, 0, 14)
    Value.Position = UDim2.new(0, 0, 0, 24)
    Value.BackgroundTransparency = 1
    Value.Font = Enum.Font.GothamMedium
    Value.Text = "💰 " .. formatNumber(data.value or 0) .. "/s"
    Value.TextColor3 = T.Accent1
    Value.TextSize = 9
    ...
    Stats.Text = "👥 " .. (data.players or "?/8") .. " | 🆔 " .. (data.job_id and data.job_id:sub(1,10).."..." or "N/A")
    Stats.TextColor3 = T.TextDim
    Stats.TextSize = 8
