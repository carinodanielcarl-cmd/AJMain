...
local function addLogEntry(data)
    ...
    PlayersLabel.Size = UDim2.new(1, 0, 0, 12)
    ...
    JobLabel.Text = "🆔 Job ID: " .. (data.job_id and data.job_id:sub(1,10).."..." or "N/A")
...
local function handleData(findings)
    ...
    table.sort(newFindings, function(a, b) return (a.timestamp or 0) < (b.timestamp or 0) end)
